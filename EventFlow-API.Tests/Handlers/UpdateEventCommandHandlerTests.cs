...
public class UpdateEventCommandHandlerTests
{
    ...
    public UpdateEventCommandHandlerTests()
    {
        ...
        _handler = new UpdateEventCommandHandler(_mockRepo.Object, _mockUnitOfWork.Object, _mockCache.Object);
    }

    [Fact]
    public async Task Handle_ExistingEvent_ReturnsSuccess()
    {
        var existingEvent = Event.Create("Old Title", "Old Desc", DateTime.UtcNow.AddDays(2), "Old Location", 1);
        var command = new UpdateEventCommand(1, "New Title", "New Desc", DateTime.UtcNow.AddDays(3), "New Location");
    ...
    {
        var command = new UpdateEventCommand(999, "Title", "Desc", DateTime.UtcNow.AddDays(1), "Location");
    ...
    public async Task Handle_PastDate_ThrowsBusinessRuleException()
    {
        ...
        var command = new UpdateEventCommand(1, "Title", "Desc", DateTime.UtcNow.AddDays(-1), "Location");
